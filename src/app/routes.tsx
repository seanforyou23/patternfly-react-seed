...
const routes: IAppRoute[] = [
  {
    ...
    exact: true,
    isAsync: true,
    label: 'Inaccessible Cat',
    path: '/',
    title: 'Inaccessible SVG',
  },
  {
    component: AccessibleCat01,
    exact: true,
    isAsync: true,
    label: 'Accessible Cat v1 (title/desc)',
    path: '/accessible-cat-01',
    title: 'Accessible Cat with title/description and group role',
  },
  {
    component: AccessibleCat02,
    exact: true,
    isAsync: true,
    label: 'Accessible Cat v2 (aria-label)',
