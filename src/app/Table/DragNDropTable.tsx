...
interface IDragAndDropTableState {
  rows: any;
  columns: any;
}
...
class DragAndDropTable extends React.Component<{}, IDragAndDropTableState> {
  constructor(props) {
    super(props);
...
export { DragDropContext, DragAndDropTable, HTML5Backend };
